...
![学术主页](./../../图片/00028_陈丹绮_谷歌学术主页截图.png)  
* 总共21篇文章，引用3876 
![danqi 博士论文概览](./../../图片/00026_陈丹绮博士论文安排.png)
...
![NLU-task-MRC](./../../图片/00028_NLU_MRC-对比.png)
...
![SAR模型图](./../../图片/00001_SAR模型图.png 'SAR模型图')
* 模型简介: 
  * 关键点1: Passage的编码部分: 
...
* 数据集简介:  
![数据集](./../../图片/00005_SAR实验数据集介绍_SQuAD_CNN-DM.png) 
* 1) CNN/Daily-Mail 数据集 ----Cloze_style test    

![CNN/DM实验结果](./../../图片/00002_SAR实验结果1.png)  
* 2) SQuAD数据集-----抽取式  
  
![SQuAD实验结果](./../../图片/00003_SAR实验结果2_SQuAD.png) 
* 实验结果分析: 
* SQuAD数据集 
  * 消融实验结果:  
![SQuAD消融实验](./../../图片/00004_SAR消融结果_SQuAD.png)   
  * 结论: 
    * EM和软对齐对于最终的结果都有影响，而且两者互补，同时去掉，结果下降很大。   
    * 数据集中 Q -- P之间存在很多重叠而且对于最终答案影响很大。  
* 分析模型到底学到了什么？  ---CNN/Daily_Mail 数据集  
  * 采样100数据进行分类: 
  * ![CNN数据采样分类](./../../图片/00006_CNN数据集采样100手工分类.png)
  * 说明:   
  ...
  * SAR按照类别的实验结果对照:   
  ![CNN/DM分类型实验结果](./../../图片/00007_SAR在CNN数据集分类型结果.png)  
  * 说明：   
...
#### 3.4 SAR 模型可以进一步进行扩展: 
  ...
  * ![attention机制](./../../图片/00008_SAR模型扩展_注意力图示.png)
...
![SAR改进](./../../图片/00009_SAR_改进点_SQuAD上被证明.png)
...
![SQuAD之后新的数据集](./../../图片/00010_SQuAD之后新的数据集.png)
...
![模型比较](./../../图片/00011_表示学习模型_复杂结构模型.png)
...
* open domain question answer 历史: 
  ...
  * ![DeepQA](./../../图片/00012_DeepQA系统_IBM_Waston.png)
...
![DrQA模型数据集统计](./../../图片/00013_DrQA_模型实验数据集统计.png)
* [有时有两个答案，DrQA设定一个对，就算对] 数据集统计2:    
![DrQA模型数据集统计2](./../../图片/00015_DrQA_模型数据集统计2.png)
#### 5.3.2 实施细节   
...
![DrQA——IR结果](./../../图片/00016_DrQA_IR结果.png)  
* 说明: 正确答案 在 检索到的 top5 passage中的比例.   

#### 5.3.4 最终结果   
![最终试验结果](./../../图片/00017_DrQA_几种版本最终实验结果.png)  
* 说明: DrQA三种不同的训练模式: 
...
![CoQA数据集分布](./../../图片/00018_CoQA数据集领域分布-统计.png)  
...
![比较](./../../图片/00018_CoQA数据集和SQuAD比较1.png)  
![比较](./../../图片/00019_CoQA数据集和SQuAD比较2.png)    
* Conversation flow  
![会话流分析](./../../图片/00020_CoQA中的会话流分析.png)  
  * X轴:随着会话进行  turn的进度条  
...
![CoQA语言现象分析](./../../图片/00021_CoQA数据集中的语言现象分布统计-举例.png) 
...
![PGNet](./../../图片/00022_Pointer-Generator-Network模型图.png)  
##### 6.3.2 阅读理解模型   SAR模型  
...
SAR： Fasttext 
##### 6.4.2 实验结果   
![实验结果](./../../图片/00023_CoQA数据集_Baseline结果.png)  
![实验结果2](./../../图片/00024_CoQA_Baseline_按照问题类型划分结果.png)  
##### 6.4.3 错误分析  
* 人类自己对于 unanswerable 和 answerable类型的定义都不是很清晰; 
* 问题类型结果分析 
* 共指影响分析      
* Importance of conversation history   
![会话历史影响](./../../图片/00025_CoQA_会话历史对于结果的影响.png)  
#### 6.5 讨论   
